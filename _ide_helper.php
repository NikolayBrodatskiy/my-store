...
namespace Illuminate\Support\Facades {
    ...
    class Route {
         ...
         * @param array|null $groupParameters
         * @return \Illuminate\Routing\Router
         * @static
         */
        public static function moonshine($callback, $withResource = false, $withPage = false, $withAuthenticate = false, $groupParameters = null)
        {
            return \Illuminate\Routing\Router::moonshine($callback, $withResource, $withPage, $withAuthenticate, $groupParameters);
        }
...
namespace MoonShine\Core\Pages {
     ...
     */
    class Pages extends \Illuminate\Support\Collection {
            }
    }
